...
const UserDashboard = () => {
  ...
  <Paper sx={{ padding: 3, marginBottom: 4 }}>
    <Typography variant="h5" sx={{ color: 'text.primary' }}>Your Meal Plan</Typography>
    <Typography variant="body1" sx={{ color: 'text.primary' }}><span style={{ color: 'red' }}>{dashboardData.mealPlan}</span></Typography>
  </Paper>
